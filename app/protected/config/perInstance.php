<?php
    ...
    $theme            = 'default';
    $connectionString = 'mysql:host=localhost;port=3306;dbname=dhamo_zurmo'; // Not Coding Standard
    $username         = 'root';
    $password         = 'root';
    ...
    $instanceConfig['components']['request']['hostInfo']         = 'http://52.66.122.104';
