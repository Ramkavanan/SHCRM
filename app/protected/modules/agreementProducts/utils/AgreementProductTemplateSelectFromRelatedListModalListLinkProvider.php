<?php
     ...
     */
    class AgreementProductTemplateSelectFromRelatedListModalListLinkProvider extends SelectFromRelatedListModalListLinkProvider
    {
        /**
        ...
        {
            $url = Yii::app()->createUrl("agreementProducts/default/addAgreementRelation", array('relationModuleId' => $this->relationModuleId,
