    ...
    class Meeting extends MashableActivity
    {
        ...
        public static function getDefaultMetadata()
        {
            ...
            $metadata[__CLASS__] = array(
                ...
                'rules' => array(
                    ...
                    array('outlooksyncid',    'type',    'type' => 'string'),
                ),
                'relations' => array(
        ...
        protected static function translatedAttributeLabels($language)
        {
            return array_merge(parent::translatedAttributeLabels($language),
                array(
                    'category'      => Zurmo::t('MeetingsModule', 'Meeting Type',    array(), null, $language),
        ...
        protected function beforeSave()
        {
            if (parent::beforeSave())
            {
                ...
                if ($this->endDateTime == '' ) {
                    $this->addError('endDateTime', Zurmo::t('Core', 'End Time cannot be blank.'));
                    return false;
                }
                return true;
            }
        ...
        public function updateOutLookSyncId($syncId, $meeting_id)
        {        
            $query = "update meeting set outlooksyncid = '$syncId' WHERE id = ".$meeting_id;            
            return ZurmoRedBean::exec($query);
        }    
            
        public function getPastMonthMeetings()
        {
            $query = "SELECT id FROM meeting WHERE DATE(startdatetime) BETWEEN DATE_SUB( LAST_DAY( DATE_ADD(NOW(), INTERVAL -1 MONTH) ), INTERVAL DAY( LAST_DAY( DATE_ADD(NOW(), INTERVAL -1 MONTH) ) )-1 DAY ) AND '2016-08-31';";
