<?php
     ...
     */
    class SelectAgmtMetadataAdapter implements StateMetadataAdapterInterface
    {
        protected $metadata;
        ...
        {
            $agmtIds = Agreement::getActiveCustomId('array');
            if(empty($agmtIds))
            {
                echo '<p><br><span style="padding-top:8px;display:block;text-align:center">Sorry, No Agreement is available.</span></p>';
                die;
            }
            ...
            $structure = '('. $startingCount . ' AND ' . $startingCountPlusOne.') AND ' . $startingCountPlusTwo;
            ...
            {
                $metadata['structure'] = str_replace('and 2', '', $metadata['structure']) . ' and (' . $structure . ')';
            }
