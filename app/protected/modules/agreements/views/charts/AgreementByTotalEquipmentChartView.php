<?php
    ...
    /**
     * A chart view for displaying a chart showing by total man hour.
     *
     */
    class AgreementByTotalEquipmentChartView extends ChartView implements PortletViewInterface
    {
	protected $agId;
	...
	public function setAgreementId($id) {
        ...
        public function renderContent()
        {
            $accessContent = $this->resolveContentIfCurrentUserCanAccessChartByModule(
                                        'AgreementsModule', 'AgreementsModulePluralLabel');
            ...
            $chartData = $chartDataProvider->setAgreemnetId($this->agId);   
            ...
            $amChart->addLegendProperties('valueWidth', 28);
            $amChart->addLegendProperties('horizontalGap', 10);
            $amChart->addLegendProperties('markerLabelGap', 15);
            ...
            $amChart->addValueAxisProperties('maximum', 10);
        ...
        public static function getDefaultMetadata()
        {
            return array(
                'perUser' => array(
                    'title' => "eval:Zurmo::t('AgreementsModule', 'Agreements By Source', LabelUtil::getTranslationParamsForAllModules())",
        ...
        {
            return 'AgreementByTotalEquipment';
        }
