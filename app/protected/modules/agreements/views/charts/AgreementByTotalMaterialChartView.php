<?php
     ...
     *
     */
    class AgreementByTotalMaterialChartView extends ChartView implements PortletViewInterface
    {
	protected $agId;
	...
	public function setAgreementId($id) {
        ...
        public function renderContent()
        {
            ...
            $amChart->addLegendProperties('valueWidth', 12);
        ...
        {
            return 'AgreementByTotalMaterial';
        }
