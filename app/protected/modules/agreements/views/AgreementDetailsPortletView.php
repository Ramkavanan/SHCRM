<?php
     ...
     */
    class AgreementDetailsPortletView extends AgreementProjectEditAndDetailsView implements PortletViewInterface
    {
        protected $params;
        protected $viewData;
	...
	private static $recordType;
	    ...
	    self::$recordType = $params['relationModel']->RecordType;
        ...
        {
	    if(self::$recordType == 'Recurring Agreement') {
		return 'AgreementRecurringEditAndDetailsView';
	    } else {
		return 'AgreementProjectEditAndDetailsView';
	    }
        }
