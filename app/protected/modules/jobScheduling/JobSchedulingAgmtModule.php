 ...
 */
class JobSchedulingAgmtModule extends SecurableModule
    {
        ...
        public static function getTranslatedRightsLabels()
        {
            ...
            $labels                              = array();
            $labels[self::RIGHT_CREATE_JOBSCHEDULING] = Zurmo::t('JobSchedulingAgmtModule', 'Create JobSchedulingModulePluralLabel',     $params);
            $labels[self::RIGHT_DELETE_JOBSCHEDULING] = Zurmo::t('JobSchedulingAgmtModule', 'Delete JobSchedulingModulePluralLabel',     $params);
            $labels[self::RIGHT_ACCESS_JOBSCHEDULING] = Zurmo::t('JobSchedulingAgmtModule', 'Access JobSchedulingModulePluralLabel Tab', $params);
            return $labels;
        }
        ...
        {
            return Zurmo::t('JobSchedulingAgmtModule', 'AgreementJob', array(), null, $language);
        }

        protected static function getPluralModuleLabel($language)
        {
            return Zurmo::t('JobSchedulingAgmtModule', 'AgreementJobs', array(), null, $language);
        }
