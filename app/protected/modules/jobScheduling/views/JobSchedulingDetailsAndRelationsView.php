<?php
    ...
    class JobSchedulingDetailsAndRelationsView extends ConfigurableDetailsAndRelationsView
    {
                ...
                'global' => array(
                    ...
                    'columns' => array(
                        array(
                            'rows' => array(
                               array(
                                    'type' => 'JobSchedulingDetailsPortlet',
                                )                              
                            )
                        ),
                        array(
        ...
        protected static function getModelRelationsSecuredPortletFrameViewClassName(){
            ...
            return 'JobSchedulingRelationsSecuredPortletFrameView';
        }
    }
?>
