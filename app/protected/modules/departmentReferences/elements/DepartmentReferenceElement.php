<?php
     ...
     * id.
     */
    class DepartmentReferenceElement extends ModelElement
    {
        protected static $moduleId = 'departmentReferences';
        ...
        {
            assert('$this->model->{$this->attribute} instanceof DepartmentReference');
