 ...
 */
 class OpportunityRecurringEditAndDetailsView extends SecuredEditAndDetailsView
    {
                            ...
                            'rows' => array(
                                ...
                                array('cells' =>
                                    array(
                                        array(
                                            'elements' => array(
                                                array('attributeName' => 'intialTermLengths', 'type' => 'DropDown', 'addBlank' => true),
                                            ),
                                        ),
                                       array(
                                            'elements' => array(
//                                                array('attributeName' => 'proposalTenderedDate', 'type' => 'Date'),
                                            ),
                                        ),
                                    ),
                                ),
        ...
        protected function getNewModelTitleLabel()
        {
           // return Zurmo::t('OpportunitiesModule', 'Create OpportunitiesModuleSingularLabel',
            //    LabelUtil::getTranslationParamsForAllModules());
                return 'Create Recurring Opportunity ';     
        }
        ...
        protected function renderAfterFormLayout($form)
        {
            ...
            if(Yii::app()->controller->action->id == 'copy' || Yii::app()->controller->action->id == 'recurringType' || Yii::app()->controller->action->id == 'projectType'){
                ...
                Yii::app()->clientScript->registerScript('stageValuesToDisabled', "
                    var optiontodisable = ['Final Pricing','Final Proposal','Agreement','Won'];
                    $('#Opportunity_stage_value option').each(function(){ if($.inArray(this.value,optiontodisable) != -1){ $(this).attr('disabled','disabled')} })
                 ");// Not Coding Standard
            }
        }
