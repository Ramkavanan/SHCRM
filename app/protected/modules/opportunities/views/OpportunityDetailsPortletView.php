<?php
	...
	private static $recordType;
        ...
        public function __construct($viewData, $params, $uniqueLayoutId)
        {
            ...
            self::$recordType = $params['relationModel']->recordType->value;
        ...
        {
		if(self::$recordType == Constant::RECURRING) {
			return 'OpportunityRecurringEditAndDetailsView';
		} else {
			return 'OpportunityProjectEditAndDetailsView';
		}
