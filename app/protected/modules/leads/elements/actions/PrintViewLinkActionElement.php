<?php
     ...
     */
    class PrintViewLinkActionElement extends LinkActionElement
    {
        ...
        {
            return Zurmo::t('LeadsModule', 'Print View');
        }
        ...
        protected function getDefaultRoute()
        {
            if (!empty($this->modelId))
            {
                ...
                return Yii::app()->createUrl($this->moduleId . '/' . $this->controllerId . '/printview/', array('id' => $this->modelId)); 
            }
            else
            {
