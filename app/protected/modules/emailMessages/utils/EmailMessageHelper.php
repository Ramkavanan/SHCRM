<?php
    ...
    class EmailMessageHelper
    {
        ...
        */
         ...
         * @return \EmailMessage
         */
        public static function customProcessAndCreateEmailMessage(Array $from, $recipients, $content='')
        {
            ...
            if(is_array($content))
            {
                ...
                {
                    $emailMessage->subject = Zurmo::t('EmailMessagesModule', $content['subject'],
                ...
                if(isset($content['content']))
                {
                    ...
                    $emailContent->textContent = EmailNotificationUtil::resolveNotificationTextTemplate(
                        Zurmo::t('EmailMessagesModule', $content['content'],
                        LabelUtil::getTranslationParamsForAllModules()));
