 ...
 * id.
 */
class AgreementTrackingElement extends ModelElement {

    protected static $moduleId = 'agreementTracking';
    ...
    protected function renderControlEditable() {
        assert('$this->model->{$this->attribute} instanceof AgreementTracking');
