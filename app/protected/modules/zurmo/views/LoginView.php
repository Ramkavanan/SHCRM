<?php
    ...
    class LoginView extends View
    {
        ...
        protected function renderContent()
        {
            ...
            $forgotPasswordLabel= $form->label        ($this->formModel, 'forgotPassword');
            ...
            $resetPasswordLink = Yii::app()->baseUrl . '/index.php/users/default/forgotPassword';
            ...
            $content .= "<div class=\"form\">$formStart"                                            .
                       ...
                       "<div class=\"remember-me\"style='float:left'>$rememberMeCheckBox$rememberMeLabel$rememberMeError </div>"   .//<span> <a href=\"$resetPasswordLink\">Forgot Password</a></span> 
                       //"<div class=\"clearfix\">$rememberMeLabel$rememberMeError</div>"      
                       "<div id='forgotpwd'><a href=\"$resetPasswordLink\" style='cursor:pointer'>$forgotPasswordLabel</a></div>"          .
                       "<div id='sub-id'>$submitButton</div>"                            .
                       "$formEnd</div>";
