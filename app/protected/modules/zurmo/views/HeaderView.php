<?php
    ...
    class HeaderView extends View
    {
        ...
        protected function resolveAndRenderLogoContent()
        {
            ...
            {
                $logoFileSrc   = Yii::app()->themeManager->baseUrl . '/default/images/main_logo.png';
            }
            $logoHeight = 55;//ZurmoUserInterfaceConfigurationFormAdapter::resolveLogoHeight();
    ...
    Yii::app()->clientScript->registerScript('hideHeaderMenuOptions',
        '$( document ).ready(function() {
            $("#settings-header-menu").find("li .last").hide();
            $("#settings-header-menu").find("li .last").prev().hide();
            $("#user-header-menu").find("li .last").prev().hide();
        });');
?>
