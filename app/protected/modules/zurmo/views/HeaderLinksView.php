<?php
    ...
    class HeaderLinksView extends View
    {
        ...
        protected static function renderHeaderMenus($userMenuItems, $settingsMenuItems)
        {
            ...
            // Modified by jagajeevan to show the settings wheel
            // For the AM, GM, CM
            ...
            $content = '';
            if(Yii::app()->user->userModel->isRootUser || $isUsersInAcountMangerGroup || $isUsersInCtalogManagerGroup || Yii::app()->user->userModel->role->name == Constant::GM)
            {
        ...
        {
            $name = Yii::app()->user->userModel->firstName.' '.Yii::app()->user->userModel->lastName;
	        ...
	        return array(array('dynamicLabelContent'  => $userAvatar,
                               ...
                               'label'                => $name,//Yii::app()->user->userModel->firstName,
                               'url'                  => null));
        }
