<?php
    ...
    class Group extends Permitable
    {
         ...
         */
        public static function getByName($name, $type = null)
        {
            ...
            if ($bean === false)
            {
                ...
                {
                     if(!empty($type) && $type === 'fromAutoComplete'){
                         echo '[{"id":null,"value":null,"label":"No results found"}]';die;
                     } else {
//                         echo "<p><br><span style='display:block;text-align:center;padding-top:8px'> Group <b>'".$name."'</b> is not available.</span></p>";die;
                     }
                }
                $group = new Group();
