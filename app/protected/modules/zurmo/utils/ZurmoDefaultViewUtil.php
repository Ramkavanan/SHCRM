<?php
    ...
    class ZurmoDefaultViewUtil
    {
        ...
        {
            // To update the recently viewed item to 20 - Modified by Sundar P - 08-Sep-2016
            $items = AuditEventsRecentlyViewedUtil::getRecentlyViewedItemsByUser(Yii::app()->user->userModel, AuditEventsRecentlyViewedUtil::RECENTLY_VIEWED_COUNT + Constant::RECENTLY_VIEWED_ADD_COUNT);
