<?php
     ...
     */
    class ActionBarForCostbookEditAndDetailsView extends ConfigurableMetadataView
    {
         ...
         */
        public function __construct($controllerId, $moduleId, Costbook $model, $activeActionElementType)
        {
