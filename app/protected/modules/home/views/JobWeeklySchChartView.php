<?php
     ...
     *
     */
    class JobWeeklySchChartView extends ChartView implements PortletViewInterface
    {
	protected $chartdataArray;// = Array();

	public function setAgId($dataArray) {
        ...
        public function renderContent()
        {
            ...
            $amChart->addCategoryAxisProperties('labelRotation',   45);
            $amChart->data = $this->chartdataArray;//$chartData;
