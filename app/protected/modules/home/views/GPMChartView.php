<?php
     ...
     *
     */
    class GPMChartView extends ChartView implements PortletViewInterface
    {
	protected $chartdataArray;// = Array();

	public function setAgIdMhr($dataArray) {
		$this->chartdataArray = $dataArray;
        ...
        public function renderContent()
        {
            ...
            $amChart->data = $this->chartdataArray;
            $amChart->id =  $this->uniqueLayoutId;
//            var_dump($this->uniqueLayoutId);exit;
            $amChart->type = ChartRules::TYPE_STACKED_COLUMN_2D;
            //$amChart->columnSpacing = 0;
