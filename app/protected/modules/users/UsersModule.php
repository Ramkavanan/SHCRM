<?php
    ...
    class UsersModule extends SecurableModule
    {
        ...
        {
            if(empty(Yii::app()->user->userModel->isRootUser) && Yii::app()->user->userModel->role->name !== Constant::GM){
                $headerMenuItems = array();    //Header Menu Items for normal users.
            }else{
                $headerMenuItems = array(   //Header Menu Items for super users GM Role.
                                        array(
