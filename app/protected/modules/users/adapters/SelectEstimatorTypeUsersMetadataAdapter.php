<?php
     ...
     */
    class SelectEstimatorTypeUsersMetadataAdapter implements StateMetadataAdapterInterface
    {
        protected $metadata;
        ...
        {
            $estimatorGroupDetails = Group::getByName('Estimator');
            ...
            if(empty($userIdArr))
            {
                echo '<p><br><span style="padding-left:15px;">Sorry, No Estimator is available</span></p>';
                die;
            }
