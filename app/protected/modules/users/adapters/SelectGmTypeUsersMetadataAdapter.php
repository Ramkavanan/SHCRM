<?php
     ...
     */
    class SelectGmTypeUsersMetadataAdapter implements StateMetadataAdapterInterface
    {
        protected $metadata;
        ...
        {
            $estimatorGroupDetails = Group::getByName('Account Manager');
            ...
            if(empty($userIdArr))
            {
                echo '<p><br><span style="padding-top:8px;display:block;text-align:center">Sorry, No GM is available.</span></p>';
                die;
            }
            ...
            $startingCountPlusTwo = $startingCountPlusOne + 1;
            $startingCountPlusThree = $startingCountPlusTwo + 1;
            ...
            if(!empty($userIdArr))
            {
                $metadata['clauses'][$startingCountPlusTwo] = array(
                    'attributeName'        => 'id',
                    'operatorType'         => 'oneOf',
                    'value'                => $userIdArr);
            }
            
            $metadata['clauses'][$startingCountPlusThree] = array(
                'attributeName'        => 'isActive',
                'operatorType'         => 'equals',
                'value'                => 1);
            
            $structure = '('. $startingCount . ' or ' . $startingCountPlusOne.') AND ' . $startingCountPlusThree . ' AND '. $startingCountPlusTwo;
