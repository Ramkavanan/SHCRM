<?php
    ...
    class OpportunityProductSelectFromRelatedListAjaxLinkActionElement extends SelectFromRelatedListAjaxLinkActionElement
    {
        /**
         * @return string
         */
        ...
        {
            return Yii::app()->createUrl('opportunityProducts/' . $this->controllerId . '/selectFromRelatedList/',
                    array(
