<?php
    ...
    class ConversationsDefaultController extends ZurmoModuleController
    {
        ...
        // For the import of conversations
        public function actionmakeAll($file_name)
        {
           $convDataObj     = new ConversationsDemoDataMaker();
           $demoDataHelper  = new DemoDataHelper();
           $convDataObj->makeImport($demoDataHelper, $file_name);
           die;
        }        
    }
?>
